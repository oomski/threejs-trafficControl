...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(e,t,n){let r=new Float32Array(os),i=new G(0,1,0);return new ga({name:`SphericalGaussianBlur`,defines:{n:os,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Cs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xs(){return new ga({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Cs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ss(){return new ga({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Cs(),fragmentShader:`
...
`)}var Yc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Xc(e,t){let n=Yc[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Zc=new G;function Qc(){return q.getLuminanceCoefficients(Zc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Zc.x.toFixed(4)}, ${Zc.y.toFixed(4)}, ${Zc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Pd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Fd=new _o(-1,1,1,-1,0,1),Id=new class extends Or{constructor(){super(),this.setAttribute(`position`,new gr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new gr([0,2,0,0,2,0],2))}},Ld=class{constructor(e){this._mesh=new ei(Id,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Fd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Rd=class extends Pd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ga?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=pa.clone(e.uniforms),this.material=new ga({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ld(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},zd=class extends Pd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Bd=class extends Pd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Vd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:y}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Rd(Nd),this.copyPass.material.blending=0,this.timer=new Oo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}zd!==void 0&&(r instanceof zd?n=!0:r instanceof Bd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Hd=class extends Pd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Ud=window.innerWidth,Wd=window.innerHeight,Gd=new Pn,Kd=new fo(75,Ud/Wd,.1,1e3);Kd.position.z=4;var qd=new cu({antialias:!0,alpha:!0});qd.setPixelRatio(Math.min(window.devicePixelRatio,2)),qd.setSize(Ud,Wd),qd.toneMapping=4,qd.toneMappingExposure=.5,qd.setClearColor(0,0),document.body.appendChild(qd.domElement),document.documentElement.style.background=`transparent`,document.body.style.background=`transparent`;var Jd=new vu(Kd,qd.domElement);Jd.enableDamping=!0;var Yd=(await new Pu().loadAsync(`/threejs-purpleSlide/Day 14 - purple slide.glb`)).scene;Yd.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),Yd.updateMatrixWorld(!0);var Xd=new Yn().setFromObject(Yd),Zd=Xd.getSize(new G),Qd=Math.max(Zd.x,Zd.y,Zd.z),$d=4;if(Qd>0){let e=$d/Qd;Yd.scale.setScalar(e),Yd.updateMatrixWorld(!0)}Xd=new Yn().setFromObject(Yd);var ef=Xd.getCenter(new G),tf=new En;Gd.add(tf),Yd.position.sub(ef),tf.add(Yd),tf.rotation.y=4*Math.PI/2,tf.rotation.x=-.1;var nf=new Ho,rf=.5;Jd.target.set(0,0,0),Jd.update();var af=!0,of=qd.domElement;of.addEventListener(`pointerdown`,()=>{af=!1},{passive:!0}),of.addEventListener(`pointerup`,()=>{af=!0},{passive:!0}),of.addEventListener(`pointercancel`,()=>{af=!0},{passive:!0}),of.addEventListener(`pointerout`,()=>{af=!0},{passive:!0}),of.addEventListener(`pointerleave`,()=>{af=!0},{passive:!0}),new ei(new oa,new va({color:16776960}));var sf=new $a(16777215,6710886,2.5);Gd.add(sf);var cf=new bo(16777215,.7);Gd.add(cf);var lf={uniforms:{tDiffuse:{value:null},saturation:{value:1.3}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},uf=new Vd(qd);uf.addPass(new Hd(Gd,Kd));var df=new Rd(lf);df.uniforms.saturation.value=1.3,uf.addPass(df);function ff(){requestAnimationFrame(ff);let e=nf.getDelta();af&&(tf.rotation.y+=rf*e,tf.rotation.y>Math.PI*2&&(tf.rotation.y-=Math.PI*2),tf.rotation.y<-Math.PI*2&&(tf.rotation.y+=Math.PI*2)),Jd.update(),uf.render()}ff();function pf(){Kd.aspect=window.innerWidth/window.innerHeight,Kd.updateProjectionMatrix(),qd.setSize(window.innerWidth,window.innerHeight),uf.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,pf,!1);